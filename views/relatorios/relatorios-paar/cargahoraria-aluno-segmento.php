...
?>
           ...
           </strong>Carga Horária Aluno por Segmentos</font></td>
    ...
    <?php
            ...
            $segmentos = Segmento::findBySql($query_segmentos)->all(); 
               ...
               //EXTRAINDO AS QUANTIDADES CONFORME O SEGMENTO E UNIDADE....
                    ...
                    $quantidade_cargahoraria_por_segmento += $quantidade_turmas * $soma_matricula * $quantidade_cargahoraria;
