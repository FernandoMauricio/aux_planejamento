...
?>
           ...
           </strong>Matrículas por Ações Extensivas</font></td>
       ...
       <?php
        ...
        $query_tipos = "SELECT tip_codtipoa, tip_descricao FROM tipodeacao_tip,planilhadecurso_placu WHERE placu_codeixo = 8 AND placu_codtipoa = tip_codtipoa GROUP BY placu_codtipoa ORDER BY tip_descricao";
          ...
          $conta_tipodeacao[$codigo_tipodeacao] = 0;
      ?>
                <th><?php echo $nome_tipodeacao; ?></th>
                ...
                $tipos = Tipo::findBySql($query_tipos)->all(); 
                  ...
                  $codigo_tipodeacao  = $tipo['tip_codtipoa'];
                   ...
                   //EXTRAINDO AS QUANTIDADES CONFORME O SEGMENTO E UNIDADE....
                       ...
                       $somar_matricula = $quantidade_alunos +  $quantidade_alunos_psg + $quantidade_alunos_isentos;
                       $quantidade_matriculas_por_tipodeacao += $quantidade_turmas * $somar_matricula;
                       $soma_total_geral                     += $quantidade_turmas * $somar_matricula;
                      }// FIM DAS QUANTIDADES..
                      
                  $conta_tipodeacao[$codigo_tipodeacao] += $quantidade_matriculas_por_tipodeacao;
                  $subtotal_unidade = $subtotal_unidade +  $quantidade_matriculas_por_tipodeacao;
              
                          
              ?>
               <td><?php echo $quantidade_matriculas_por_tipodeacao; ?></td>
              <?php
