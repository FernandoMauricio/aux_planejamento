...
?>
           ...
           </strong>Carga Horária por Unidade</font></td>
		   ...
		   //EXTRAINDO AS UNIDADES DAS PLANILHAS....
            ...
            foreach ($unidades as $unidade) {
			  ...
			  $subtotal_unidade = 0;
				  ...
				  //EXRAINDO AS INFORMAÇÕES DAS PLANILHAS...
				$query_planilhas = "SELECT placu_codeixo,placu_quantidadeturmas,placu_cargahorariaarealizar, placu_cargahorariavivencia FROM planilhadecurso_placu WHERE placu_codunidade = '".$codigo_unidade."' AND placu_codsituacao = '".$situacao_planilha['sipla_codsituacao']."' AND placu_codano = '".$ano_orcamento['an_codano']."' AND placu_codtipla = '".$tipo_planilha['tipla_codtipla']."'";
            ...
            foreach ($planilhas as $planilha) {
			  ...
			  $carga_horaria             = $planilha['placu_cargahorariaarealizar'];
			  $carga_horaria_vivencia    = $planilha['placu_cargahorariavivencia'];
						 
						 $carga_horaria += $carga_horaria_vivencia;
      ...
      <?php
		  ...
		  ?>
                 ...
                 <td><strong><?php echo $quantidade_acao_extensiva_geral; ?></strong></td>
