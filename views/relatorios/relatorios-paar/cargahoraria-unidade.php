		   ...
		   //EXTRAINDO AS UNIDADES DAS PLANILHAS....
            ...
            foreach ($unidades as $unidade) {
			  ...
			  $subtotal_unidade = 0;
				  ...
				  //EXRAINDO AS INFORMAÇÕES DAS PLANILHAS...
				$query_planilhas = "SELECT placu_codeixo,placu_quantidadeturmas,placu_cargahorariaarealizar, placu_cargahorariavivencia FROM planilhadecurso_placu WHERE placu_codunidade = '".$codigo_unidade."' AND placu_codsituacao = '".$situacao_planilha['sipla_codsituacao']."' AND placu_codano = '".$ano_orcamento['an_codano']."' AND placu_codprogramacao = '".$tipo_programacao['tipro_codprogramacao']."' AND placu_codtipla = '".$tipo_planilha['tipla_codtipla']."'";
