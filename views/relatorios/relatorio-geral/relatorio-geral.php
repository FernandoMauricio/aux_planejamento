...
?>
		...
		<?php
		   ...
		   if($combounidade['placu_codunidade'] == 0)//TODAS...
		    { 
		     	   $query_unidades = "SELECT placu_nomeunidade, placu_codunidade FROM `db_apl`.`planilhadecurso_placu` WHERE placu_codsituacao = '".$situacao_planilha['sipla_codsituacao']."' AND placu_codtipla = '".$tipo_planilha['tipla_codtipla']."' GROUP BY placu_codunidade ORDER BY placu_nomeunidade";
            } else //UMA UNIDADE EM ESPECÍFICO...
		           $query_unidades = "SELECT placu_nomeunidade,placu_codunidade FROM planilhadecurso_placu WHERE placu_codsituacao = '".$situacao_planilha['sipla_codsituacao']."' AND placu_codtipla = '".$tipo_planilha['tipla_codtipla']."' AND placu_codunidade = '".$combounidade['placu_codunidade']."' GROUP BY placu_codunidade ORDER BY placu_nomeunidade";
		...
		?>
					 ...
					 $query_eixos = "SELECT eix_descricao, eix_codeixo FROM eixo_eix, planilhadecurso_placu WHERE placu_codunidade = '".$codigo_unidade."' AND placu_codsituacao = '".$situacao_planilha['sipla_codsituacao']."' AND placu_codtipla = '".$tipo_planilha['tipla_codtipla']."' AND placu_codeixo = eix_codeixo GROUP BY placu_codeixo ORDER BY eix_descricao";
			           ...
			           foreach ($eixos as $eixo) {
			           	...
			           	$nome_eixo   = $eixo['eix_descricao'];
						      ...
						      <?php
							   ...
							   //EXTRAINDO OS EIXOS DAS PLANILHAS CONFORME A UNIDADE ACIMA...
					           $query_segmentos = "SELECT seg_descricao, seg_codsegmento FROM segmento_seg, planilhadecurso_placu WHERE placu_codunidade = '".$codigo_unidade."' AND placu_codsituacao = '".$situacao_planilha['sipla_codsituacao']."' AND placu_codtipla = '".$tipo_planilha['tipla_codtipla']."' AND placu_codeixo = '".$codigo_eixo."' AND placu_codsegmento = seg_codsegmento GROUP BY placu_codsegmento ORDER BY seg_descricao";
						          $segmentos = Segmento::findBySql($query_segmentos)->all(); 
									  ...
									  $query_tipos = "SELECT tip_descricao, tip_codtipoa FROM tipodeacao_tip, planilhadecurso_placu WHERE placu_codunidade = '".$codigo_unidade."' AND placu_codsituacao = '".$situacao_planilha['sipla_codsituacao']."' AND placu_codtipla = '".$tipo_planilha['tipla_codtipla']."' AND placu_codeixo = '".$codigo_eixo."' AND placu_codsegmento = '".$codigo_segmento."' AND placu_codtipoa = tip_codtipoa GROUP BY placu_codtipoa ORDER BY tip_descricao";
