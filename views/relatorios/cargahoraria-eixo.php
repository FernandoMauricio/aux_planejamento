...
?>
           ...
           </strong>Carga Horária por Eixos Tecnol&oacute;gicos</font></td>
                     ...
                     <?php
					  ...
					  $query_eixos2 = "SELECT eix_codeixo, eix_descricao FROM eixo_eix WHERE eix_codeixo <> 8 ORDER BY eix_descricao";
			           ...
			           foreach ($eixos2 as $eixo2) {
				        ...
				        $query_cargahorariaEixo = "SELECT placu_quantidadeturmas, placu_cargahorariaarealizar, placu_cargahorariavivencia FROM planilhadecurso_placu WHERE placu_codsituacao = '".$situacao_planilha['sipla_codsituacao']."' AND placu_codano = '".$ano_orcamento['an_codano']."' AND placu_codtipla = '".$tipo_planilha['tipla_codtipla']."' AND placu_codunidade = '".$codigo_unidade."' AND placu_codeixo = '".$codigo_eixo."'";
			            ...
			            foreach ($cargaHorariaEixos as $cargaHorariaEixo) {
						    ...
						    $quantidade_cargahoraria_vivencia = $cargaHorariaEixo['placu_cargahorariavivencia'];
								   ...
								   $quantidade_cargahoraria_por_eixo = $quantidade_cargahoraria_por_eixo + ($quantidade_turmas * $quantidade_cargahoraria);
								   $soma_total_geral = $soma_total_geral + ($quantidade_turmas * $quantidade_cargahoraria);
					        }// FIM DAS QUANTIDADES..
					        
							$conta_eixo[$codigo_eixo] = $conta_eixo[$codigo_eixo] + $quantidade_cargahoraria_por_eixo;
							$subtotal_unidade = $subtotal_unidade + $quantidade_cargahoraria_por_eixo;
