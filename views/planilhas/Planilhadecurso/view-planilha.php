...
<div class="planilhadecurso-view">
    ...
    <div class="panel panel-default">
        ...
        <br>
          ...
          <div class="row">
                  <div class="col-md-3"><strong>Preço de Venda pela planilha:</strong><br> <?php echo 'R$ ' . number_format( $model->placu_vendaaluno, 2, ',', '.'); ?></div>
        ...
        <br>
          ...
          <div class="row">
                  <div class="col-md-3" style="color: green;"><strong>Preço de Venda:</strong><br> <?php echo 'R$ ' . number_format( $model->placu_precosugerido, 2, ',', '.'); ?></div>

                  <div class="col-md-3"><strong>Retorno com Preço de Venda:</strong><br> <?php echo 'R$ ' . number_format( $model->placu_retornoprecosugerido, 2, ',', '.'); ?></div>

                  <div class="col-md-3"><strong>Numero minimo de alunos por turma:</strong><br> <?php echo $model->placu_minimoaluno; ?></div>

                  <div class="col-md-3"><strong>% de Retorno - Preço de Venda:</strong><br>  <?php echo number_format($model->placu_porcentprecosugerido, 2, ',', '.') . '%'; ?></div>
