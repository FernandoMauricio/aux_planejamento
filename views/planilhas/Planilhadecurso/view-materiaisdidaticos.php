          ...
          <thead>
           ...
           <tbody>
            ...
            <tr>
                ...
                <td><a target="_blank" href="http://portalsenac.am.senac.br/aux_planejamento/web/uploads/repositorio/<?php echo $modelPlaniMaterial->planima_codrepositorio . '/' . $modelPlaniMaterial->planima_arquivo ?>"> <?php echo $modelPlaniMaterial->planima_arquivo ?></a></td>
            </tr>
            <?php
