...
<div class="panel panel-primary">
  ...
  <table class="table table-condensed table-hover">
    ...
    <tbody>
        <tr>
            <td style="font-size:11px;" colspan="3"><strong>Unidade: </strong> <?php echo $model->unidade->uni_nomeabreviado; ?></td>
            <td style="font-size:11px;" colspan="3" ><strong>Plano de Ação: </strong> <?php echo $model->planodeacao->plan_descricao; ?></td> 
            <td style="font-size:11px;" colspan="3"><strong>Carga Horária: </strong><br> <?php echo $model->planp_cargahoraria; ?></td>
            <td style="font-size:11px;" colspan="3"><strong>Qnt Alunos: </strong><br> <?php echo $model->planp_qntaluno; ?></td>
        </tr> 
    </tbody>
 </table>
   ...
   <table class="table table-condensed table-hover">
    ...
    <tbody>
        <tr>
            ...
            <td style="font-size:11px;" colspan="4" ><strong>T. Horas Docente: </strong><br> <?php echo $model->planp_totalhorasdocente; ?></td> 
            <td style="font-size:11px;" colspan="4"><strong>Vr. hora/aula S. Pedagógico (s/produtividade): </strong><br> <?php echo $model->planp_servpedagogico; ?></td>
        </tr>
        <tr>
            <td style="font-size:11px;" colspan="4"><strong>V. Hora/Aula: </strong><br> <?php echo 'R$ ' . number_format($model->planp_valorhoraaula, 2, ',', '.'); ?></td>
            <td style="font-size:11px;" colspan="4" ><strong>V. Hora/Aula Planejamento: </strong> <br> <?php  echo 'R$ ' . number_format($model->planp_horaaulaplanejamento, 2, ',', '.'); ?></td> 
        ...
        <tr>
            <td style="font-size:11px;" colspan="3"><strong>Material Didático/Aluno/Consumo: </strong><br> <?php echo 'R$ ' .  number_format($model->planp_custosmateriais, 2, ',', '.'); ?></td>
            ...
            <td style="font-size:11px;" colspan="3"><strong>V. Hora/Aula de Custo Direto: </strong><br> <?php echo 'R$ ' . number_format( $model->planp_totalhoraaulacustodireto, 2, ',', '.'); ?></td>
        </tr>
    </tbody> 
   </table>
   ...
   <table class="table table-condensed table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="font-size:11px;" colspan="3"><strong>V. Hora/Aula por Aluno: </strong><br> <?php echo 'R$ ' . number_format( $model->planp_horaaulaaluno, 2, ',', '.'); ?></td>
