...
<div class="precificacao1-view">
        ...
        <br>
         ...
         <br>
          ...
          <div class="row">
                  <div class="col-md-3"><strong>Mat. Didático (Apostila):</strong><br> <?php echo 'R$ ' .  number_format($model->planp_PJApostila, 2, ',', '.'); ?></div>

                  <div class="col-md-3"><strong>Mat. Didático (Livros):</strong><br> <?php echo 'R$ ' .  number_format($model->planp_custosmateriais, 2, ',', '.'); ?></div>
