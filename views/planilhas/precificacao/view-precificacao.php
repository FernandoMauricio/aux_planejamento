<div class="precificacao1-view">
   ...
   <div class="row">
      ...
      <div class="col-md-3" style="color: #F7941D;"><b>Total Custo Indireto:</b><br> <?= 'R$ ' . number_format( $model->planp_totalcustoindireto, 2, ',', '.'); ?></div>
   ...
   <div class="row">
      <div class="col-sm-6" style="text-align: center; border-right: 4px solid rgb(255, 224, 174);"><br>
         <div class="row">
            <div class="col-md-3" style="color: green;"><b>Preço de Venda:</b><br> <?= 'R$ ' . number_format( $model->planp_precosugerido, 2, ',', '.'); ?></div>
            <div class="col-md-3"><b>Retorno R$:</b><br> <?= 'R$ ' . number_format( $model->planp_retornoprecosugerido, 2, ',', '.'); ?></div>
            <div class="col-md-3"><b>Valor Total:</b><br> <?= 'R$ ' . number_format( $model->planp_vendaturmasugerido, 2, ',', '.'); ?></div>
            <div class="col-md-3"><b>% de Retorno:</b><br> <?= number_format($model->planp_porcentretornosugerido, 2, ',', '.') . '%'; ?></div>
         </div><br>
   
         <div class="row">
            <div class="col-md-3"><b>Parcelas:</b><br> <?= $model->planp_parcelas; ?></div>
            <div class="col-md-4"><b>Valor das Parcelas:</b><br> <?= 'R$ ' . number_format( $model->planp_valorparcelas, 2, ',', '.'); ?></div>
            <div class="col-md-4"><b>Mínimo de Alunos:</b><br> <?= $model->planp_minimoaluno; ?></div>
         </div><br>
      </div>

      <div class="col-sm-6" style="text-align: center;"><br>
         <div class="row">
            <div class="col-md-3" style="color: green;"><b>Preço de Venda:</b><br> <?= 'R$ ' . number_format( $model->planp_valorcomdesconto, 2, ',', '.'); ?></div>
            <div class="col-md-3"><b>Retorno R$:</b><br> <?= 'R$ ' . number_format( $model->planp_retornoprecosugeridointerior, 2, ',', '.'); ?></div>
            <div class="col-md-3"><b>Valor Total:</b><br> <?= 'R$ ' . number_format( $model->planp_vendaturmasugeridointerior, 2, ',', '.'); ?></div>
            <div class="col-md-3"><b>% de Retorno:</b><br> <?= number_format($model->planp_porcentretornosugeridointerior, 2, ',', '.') . '%'; ?></div>
         </div><br>
