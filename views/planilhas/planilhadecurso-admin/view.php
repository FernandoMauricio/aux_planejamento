...
$this->params['breadcrumbs'][] = ['label' => 'Listagem Planilhas de Curso - Administrador', 'url' => ['/planilhas/planilhadecurso-admin/index']];
...
?>
    ...
    <p>
        <?php 
            ...
            echo Html::a('Listagem de Planilhas', ['/planilhas/planilhadecurso-admin/index'], ['class' => 'btn btn-warning']);
            }
        ?>
    </p>
