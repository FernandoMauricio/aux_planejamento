...
/* @var $searchModel app\models\planilhas\PlanilhaJustificativasSearch */
...
<div class="planilha-justificativas-index">
    ...
    <p>
        <?= Html::button('Inserir Justificativa', ['value'=> Url::to('index.php?r=planilhas/planilha-justificativas/create'), 'class' => 'btn btn-success', 'id'=>'modalButton']) ?>
    </p>
