...
class PlanilhadecursoAdminSearch extends PlanilhadecursoAdmin
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'placu_encargos' => $this->placu_encargos,
