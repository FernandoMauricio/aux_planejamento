...
class Planilhadecurso extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'placu_tiporelatorio' => 'Tipo de Relatório',
