...
class MaterialCopiasPendentes extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['matc_qtexemplares', 'matc_curso', 'matc_centrocusto', 'situacao_id', 'matc_totalValorMono', 'matc_totalValorColor'], 'required'],
            [['situacao_id','matc_totalValorMono', 'matc_totalValorColor', 'matc_autorizado', 'matc_encaminhadoRepro'], 'integer'],
